...
_sage_const_2 = Integer(2); _sage_const_10 = Integer(10); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4)# To run this script in parallel: ls ./flats/ | parallel -j57 "sage generic_part_2.sage {}"
import sys
import os 
...
FILE_NAME_new = './flats/unfiltered/'+ FILE_NAME.replace('.txt', '').replace('./flats/','')     + f'_unfiltered' + '.txt'
